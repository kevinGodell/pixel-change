...
console.time('=====> testing rgb pixel changes with regions set');
...
p2p.once('pam', (pam)=> {
    ...
    p2p.on('pam', (pam)=> {
        ...
        buf0 = buf1;
        buf1 = pam.pixels;
        console.time('cpp rgb regions');
        const percent0 = PixelChange.compareRgbRegions(width, height, regions, buf0, buf1);
        console.timeEnd('cpp rgb regions');
...
ffmpeg.on('exit', (code, signal) => {
    ...
    console.timeEnd('=====> testing rgb pixel changes with regions set');
});
