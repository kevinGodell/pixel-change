...
//using static method of PixelChange to get percent of changed pixels
...
p2p.once('pam', (pam)=> {
    ...
    p2p.on('pam', (pam)=> {
        ...
        buf0 = buf1;
        buf1 = pam.pixels;
        const percent = PixelChange.compareRgbPixels(400, 225, 1, buf0, buf1);
        assert(percent === pixelChangeResults[pixelChangeCounter++], 'pixel change percent is not correct');
    });
