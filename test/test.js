...
//listening to change event for percent of changed pixels
...
p2p.once('pam', (pam)=> {
    ...
    const pc = new PixelChange({width: pam.width, height: pam.height, depth: pam.depth, difference: 1, percent: 1});
